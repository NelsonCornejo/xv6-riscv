...
mkfs/mkfs: mkfs/mkfs.c kernel/fcntl.h kernel/types.h kernel/fs.h kernel/stat.h kernel/param.h
	gcc -Wall -I/usr/include -Ikernel -I. -o mkfs/mkfs mkfs/mkfs.c -D_XOPEN_SOURCE=700 -D_GNU_SOURCE
